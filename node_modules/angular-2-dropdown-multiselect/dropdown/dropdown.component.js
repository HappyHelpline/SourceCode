...
var MultiselectDropdown = (function () {
    function MultiselectDropdown(element, fb, searchFilter, differs) {
        ...
        this.defaultSettings = {
            ...
            buttonClasses: 'btn btn-default btn-secondary myh_btn',
        ...
        this.defaultTexts = {
            ...
            defaultTitle: 'Select time to recieve appointments',
    ...
    MultiselectDropdown.prototype.updateTitle = function () {
        ...
        if (this.numSelected === 0 || this.settings.fixedTitle) {
            ...
            this.title = useOptions
                ...
                .map(function (option) { return option.elementname; })
                .join(', ');
        }
        else {
